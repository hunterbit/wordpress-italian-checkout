...
1. Scarica il file **[wc-italian-fiscal-fields-v2.0.1.zip](wc-italian-fiscal-fields-v2.0.1.zip)**
...
1. Clona questa repository o scarica il codice
2. Copia la cartella `wc-italian-fiscal-fields` in `/wp-content/plugins/`
3. Vai in **WordPress Admin → Plugin**
4. Trova "WooCommerce Italian Fiscal Fields" e clicca **Attiva**

**IMPORTANTE**: Assicurati che WooCommerce sia installato e attivato prima di installare questo plugin.
...
Se riscontri problemi durante l'installazione o l'utilizzo del plugin, consulta il documento **[TROUBLESHOOTING.md](TROUBLESHOOTING.md)** per una guida dettagliata alla risoluzione dei problemi più comuni.
